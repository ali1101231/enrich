...
export function FloatingHelpFab() {
  ...
  return (
    <div className="fixed bottom-8 right-5 z-40 flex flex-col items-end gap-2">
      <div
        className={cn(
      ...
      >
        <Button asChild variant="secondary" size="icon" className="h-11 w-11 rounded-full border border-border shadow-glow-sm">
      ...
      <Button
        ...
        className={cn(
          'h-14 w-14 rounded-full gradient-koldify text-white shadow-glow hover:opacity-95',
