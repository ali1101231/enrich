...
export const mockTools: Tool[] = [
  ...
  // Blitz Tools
  {
    id: 'blitz-key-info',
    name: 'Key Info',
    description: 'View your Blitz API key information, plan, and rate limits',
    provider: 'blitz',
    icon: 'Key',
    category: 'Account',
    requiredFields: [],
  ...
  },
  {
    ...
    description: 'Get contact info from phone numbers',
    provider: 'blitz',
    icon: 'Phone',
    category: 'Lookup',
    requiredFields: [
      { id: 'phone', name: 'Phone Number', description: 'Phone number', type: 'phone', aliases: ['phone_number', 'mobile', 'cell'] },
    ],
    optionalFields: [],
  },
  {
    ...
    description: 'Get contact info from email addresses',
    provider: 'blitz',
    icon: 'AtSign',
    category: 'Lookup',
    requiredFields: [
  ...
  },
  {
    ...
    name: 'Find Mobile & Direct Phone',
    description: 'Find mobile and direct phone numbers for contacts',
    provider: 'blitz',
    icon: 'Smartphone',
    category: 'Enrichment',
    requiredFields: [
      { id: 'name', name: 'Full Name', description: 'Contact full name', type: 'text', aliases: ['full_name', 'first_name', 'contact'] },
      { id: 'company', name: 'Company', description: 'Company name', type: 'text', aliases: ['company_name', 'organization', 'employer'] },
    ],
    optionalFields: [],
  },
  {
    id: 'blitz-email-enricher',
    name: 'Blitz Email Enricher',
    description: 'Enrich contacts with verified email addresses',
    provider: 'blitz',
    icon: 'MailPlus',
    category: 'Enrichment',
    requiredFields: [
  ...
  {
    id: 'linkedin-to-domain',
    name: 'LinkedIn URL to Domain',
    description: 'Extract company domain from LinkedIn company pages',
    provider: 'blitz',
    icon: 'Globe',
    category: 'Conversion',
    requiredFields: [
      { id: 'linkedin_url', name: 'LinkedIn Company URL', description: 'LinkedIn company page URL', type: 'url', aliases: ['company_url', 'linkedin'] },
    ],
    optionalFields: [],
  },
  {
    ...
    description: 'Find LinkedIn company page from domain',
    provider: 'blitz',
    icon: 'Linkedin',
    category: 'Conversion',
    requiredFields: [
      { id: 'domain', name: 'Domain', description: 'Company domain', type: 'domain', aliases: ['website', 'url', 'company_domain'] },
    ],
    optionalFields: [],
  },
  {
    id: 'waterfall-icp',
    name: 'Waterfall ICP',
    description: 'Multi-source enrichment for ideal customer profiles',
    provider: 'blitz',
    icon: 'Layers',
    category: 'Enrichment',
    requiredFields: [
  ...
  },
  {
    ...
    description: 'Find employees at target companies',
    provider: 'blitz',
    icon: 'Users',
    category: 'Discovery',
    requiredFields: [
      { id: 'company', name: 'Company', description: 'Company name or domain', type: 'text', aliases: ['company_name', 'domain', 'organization'] },
    ],
    optionalFields: [
      { id: 'title', name: 'Job Title', description: 'Filter by job title', type: 'text', aliases: ['job_title', 'role', 'position'] },
    ],
  },
  {
    id: 'current-datetime',
    name: 'Current Date/Time',
    description: 'Add current timestamp to records',
    provider: 'blitz',
    icon: 'Clock',
    category: 'Utility',
    requiredFields: [],
