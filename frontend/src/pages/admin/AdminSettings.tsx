  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Admin portal preferences</p>
      </div>
          ...
          <CardContent>
            ...
            >
              {themes.map((theme) => (
                <Label
                  key={theme.value}
                  htmlFor={`admin-theme-${theme.value}`}
                  className={cn(
                ...
                >
                  <RadioGroupItem value={theme.value} id={`admin-theme-${theme.value}`} className="sr-only" />
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Notify when a run encounters errors
                </p>
              </div>
              <Switch
