...
const envSchema = z.object({
  ...
  SCHEDULER_POLL_MS: z.coerce.number().int().positive().default(2000),
  SCHEDULER_MAX_ENQUEUE: z.coerce.number().int().positive().default(20),
  PER_USER_ACTIVE_JOB_LIMIT: z.coerce.number().int().positive().default(2),
  PER_KEY_ACTIVE_JOB_LIMIT: z.coerce.number().int().positive().default(5),
